...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-indigo-500/30 font-sans overflow-x-hidden">
      ...
      <nav className="fixed top-6 left-0 right-0 z-50 px-6 mx-auto max-w-7xl w-full">
        <motion.div 
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm md:text-base font-black tracking-tight text-white">
              BOOST<span className="text-zinc-500">MGR</span>
            </span>
          </div>
          <div className="flex items-center gap-2 md:gap-4 shrink-0">
            <Link href="/login" className="text-[10px] md:text-xs font-bold text-zinc-400 hover:text-white transition-colors uppercase tracking-[0.2em] px-4 py-2">
              Sign In
            </Link>
            <Link href="/signup" className="bg-white hover:bg-zinc-200 text-black px-5 py-2.5 rounded-full text-[10px] md:text-xs font-black transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] uppercase tracking-[0.2em] flex items-center gap-2">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-48 pb-32 flex flex-col items-center text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900/80 backdrop-blur-xl border border-white/10 text-zinc-300 text-[10px] font-black uppercase tracking-[0.2em] rounded-full mb-10 shadow-xl"
        >
        ...
        <motion.h1 
          className="text-6xl md:text-8xl lg:text-9xl font-black leading-[0.85] tracking-tighter text-white mb-8 max-w-5xl"
        ...
        <motion.p 
          className="text-lg md:text-xl text-zinc-400 mb-12 max-w-2xl font-medium leading-relaxed"
        ...
        >
          ...
          <Link href="/login" className="flex items-center justify-center gap-3 bg-zinc-900/50 backdrop-blur-xl border border-white/5 hover:bg-zinc-800 text-white px-10 py-5 rounded-full text-sm font-black transition-all hover:border-white/20 uppercase tracking-widest">
            View Dashboard
          </Link>
        </motion.div>
            ...
            <div className="flex justify-between items-center border-b border-white/5 pb-8 mb-8">
               <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                     <h4 className="text-lg font-black text-white">Live Network Pulse</h4>
                     <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest">System Operational</p>
                  </div>
               </div>
               <div className="hidden md:flex gap-4">
                  <div className="bg-zinc-900 border border-white/5 rounded-lg px-4 py-2 text-xs font-bold text-zinc-400">24h Volume: <span className="text-white">$14,204</span></div>
               ...
               {[
                 ...
                 <motion.div key={i} whileHover={{ y: -5 }} className="bg-zinc-900/50 border border-white/5 rounded-2xl p-6 backdrop-blur-xl">
                    <div className="flex justify-between items-center mb-6">
                       <span className="text-xs font-black text-zinc-400 uppercase tracking-widest">{stat.p}</span>
                       <span className="text-lg font-black text-white">{stat.v}%</span>
                    </div>
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-40">
        <div className="text-center max-w-3xl mx-auto mb-24">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-8 text-white">Engineered for Dominance.</h2>
          <p className="text-lg text-zinc-400 font-medium leading-relaxed">Stop guessing with manual ads. Our proprietary algorithms route your capital for maximum engagement across global networks in milliseconds.</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            >
              <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-indigo-500/20 group-hover:border-indigo-500/50 group-hover:text-indigo-400 transition-all text-white">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-32 mb-20">
        <div className="bg-gradient-to-br from-indigo-900/50 to-rose-900/20 border border-white/10 rounded-[40px] p-12 md:p-24 text-center overflow-hidden relative">
           ...
           <div className="relative z-10 flex flex-col items-center">
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-white mb-8">Ready to Scale?</h2>
      ...
      <footer className="relative z-10 border-t border-white/5 bg-black text-center py-12">
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <span className="text-lg font-black tracking-tight text-white">BOOSTMGR</span>
        </div>
