    ...
    <div className="min-h-screen bg-surface flex selection:bg-indigo-500/30 font-sans relative overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative flex-col justify-between p-12 overflow-hidden border-r border-black/30 z-10 bg-surface">
         ...
         <div className="absolute inset-0 z-0">
            ...
            <div className="absolute bottom-[-10%] right-[-20%] w-[60%] h-[60%] rounded-full bg-indigo-600/5 blur-[100px] mix-blend-screen animate-pulse" style={{ animationDuration: '12s' }} />
         </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            >
              {loading ? (
                ...
                <>
                  Initialize Account <UserPlus size={16} className="group-hover:translate-x-1 transition-transform" />
                </>
              )}
            </button>
          </form>
