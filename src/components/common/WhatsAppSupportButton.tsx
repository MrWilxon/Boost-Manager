...
export const WhatsAppSupportButton = () => {
  ...
  return (
    <div className="fixed right-6 bottom-6 z-[100] group flex items-center flex-row-reverse gap-3">
      <a
        href={`https://wa.me/${adminPhone}?text=${encodeURIComponent(message)}`}
        target="_blank"
        rel="noopener noreferrer"
        className="relative w-12 h-12 rounded-full nm-flat flex items-center justify-center text-[#25D366] hover:text-[#20bd5a] hover:nm-concave active:scale-[0.98] active:nm-inset transition-all duration-200 cursor-pointer shadow-[-4px_-4px_12px_rgba(255,255,255,0.04),_4px_4px_12px_rgba(0,0,0,0.5)] hover:shadow-[-5px_-5px_15px_rgba(255,255,255,0.06),_5px_5px_15px_rgba(0,0,0,0.6)]"
